...
export default function AdjacentPost({
  ...
  return (
    <Link className="relative w-full bg-black max-h-56" href={`/post/${path}`}>
      <Image
        ...
        height={100}
      />
      <div className="group absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex justify-around items-center px-8 text-white">
